        ...
        <div class="max-w-lg mx-auto bg-white shadow-lg p-6 rounded-lg">
            <form method="post" action="{{route('addUnits')}}" class="space-y-4">
                ...
                <div>
                    ...
                    <input required type="number" id="units" name="units" min="1" max="10" step="1" class="w-full p-2 mt-1 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500">
                </div>
